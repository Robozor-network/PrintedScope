	...
	translate(v = [0, 0, -14.0000000000]) {
		union() {
			...
			rotate(a = [0, 0, 0.0000000000]) {
				translate(v = [0, -38.5500000000, 0]) {
					cube(size = [65, 77.1000000000, 28]);
				}
			}
		}
	}
	rotate(a = [0, 0, 60]) {
		translate(v = [0, -1, -17.1000000000]) {
			cube(size = [200, 50, 100]);
		}
	}
	rotate(a = [0, 0, -60]) {
		translate(v = [0, -49, -17.1000000000]) {
			cube(size = [200, 50, 100]);
		}
	}
	rotate(a = [0, 90, 0.0000000000]) {
		translate(v = [0, -20.0000000000, 7]) {
			cylinder($fn = 20, d = 17.1000000000, h = 100);
		}
		translate(v = [0, 20.0000000000, 7]) {
			cylinder($fn = 20, d = 17.1000000000, h = 100);
		}
