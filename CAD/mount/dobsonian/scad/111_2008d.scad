				...
				difference() {
													...
													difference() {
														hull() {
															translate(v = [0, -13.5000000000, -3]) {
																...
																translate(v = [0, 13.5000000000, 13.5000000000]) {
																	rotate(a = [0, 90, 0]) {
																		cylinder($fn = 50, d = 25.0000000000, h = 100);
																	}
																}
															}
														}
														translate(v = [0, -10.5000000000, -2]) {
															translate(v = [0, 10.5000000000, 10.5000000000]) {
																rotate(a = [0, 90, 0]) {
																	cylinder($fn = 50, d = 17.0000000000, h = 101);
																}
															}
														}
						...
						difference() {
							rotate(a = [  0,  0,-45]) {
								translate(v = [155.0000000000, 205.0000000000, 0]) {
									rotate(a = [0, 0, 0]) {
										difference() {
											cylinder($fn = 50, d = 32.0000000000, h = 35);
										}
									}
								}
								translate(v = [155.0000000000, 205.0000000000, 30]) {
									rotate(a = [  0.        , 17.92558313,195.7000166 ]) {
										difference() {
											cylinder($fn = 50, d = 27.0000000000, h = 5);
											cylinder($fn = 50, d = 17.0000000000, h = 5);
										}
									}
								}
							}
					...
					rotate(a = [  0,  0,-45]) {
						translate(v = [155.0000000000, 205.0000000000, 30]) {
							rotate(a = [  0.        , 17.92558313,195.7000166 ]) {
								translate(v = [0, 0, 2]) {
									cylinder($fn = 50, d = 17.0000000000, h = 50);
								}
								translate(v = [0, 0, -50]) {
									cylinder($fn = 50, d = 5.6000000000, h = 100);
								}
								translate(v = [0, 0, -53]) {
									cylinder($fn = 50, d = 10.2000000000, h = 50);
								}
							}
						}
					}
				...
				rotate(a = [  0,  0,-45]) {
					...
					translate(v = [205.0000000000, 155.0000000000, 30]) {
						rotate(a = [  0.        , 35.82279184,237.6687916 ]) {
							difference() {
								translate(v = [0, 0, -5]) {
									cylinder($fn = 50, d = 27.0000000000, h = 10);
								}
								cylinder($fn = 50, d = 17.0000000000, h = 5);
							}
						}
