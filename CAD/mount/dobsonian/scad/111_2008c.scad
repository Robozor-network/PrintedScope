			...
			difference() {
				union() {
					intersection() {
						union() {
							...
							intersection() {
								translate(v = [241.4875000000, 0, 30]) {
									rotate(a = [0, 0, 135]) {
										translate(v = [-15, 0, 0]) {
											union() {
												difference() {
													hull() {
														translate(v = [0, -13.1000000000, -3]) {
															cube(size = [100, 26.2000000000, 4]);
															translate(v = [0, 13.1000000000, 13.1000000000]) {
																rotate(a = [0, 90, 0]) {
																	cylinder($fn = 50, d = 24.2000000000, h = 100);
																}
															}
														}
													}
													translate(v = [0, -10.1000000000, -2]) {
														translate(v = [0, 10.1000000000, 10.1000000000]) {
															rotate(a = [0, 90, 0]) {
																cylinder($fn = 50, d = 16.2000000000, h = 101);
															}
														}
													}
													translate(v = [50.0000000000, 0, 17.2000000000]) {
														rotate(a = [0,0,0]) {
															union() {
																cube(size = 0);
																translate(v = [0, 0, -0.1000000000]) {
							...
							translate(v = [241.4875000000, 0, 30]) {
								rotate(a = [0, 0, -135]) {
									translate(v = [-10, -13.1000000000, -3.2000000000]) {
										cube(size = [200, 26.2000000000, 0.2000000000]);
									}
								}
							}
						}
					...
					difference() {
						rotate(a = [  0,  0,-45]) {
							translate(v = [155.0000000000, 205.0000000000, 0]) {
								rotate(a = [0, 0, 0]) {
									difference() {
										cylinder($fn = 50, d = 31.2000000000, h = 35);
									}
								}
							}
							translate(v = [155.0000000000, 205.0000000000, 30]) {
								rotate(a = [  19.10963055,  19.40442264, 263.43364791]) {
									difference() {
										cylinder($fn = 50, d = 26.2000000000, h = 5);
										cylinder($fn = 50, d = 16.2000000000, h = 5);
									}
								}
							}
						}
				...
				rotate(a = [  0,  0,-45]) {
					translate(v = [155.0000000000, 205.0000000000, 30]) {
						rotate(a = [  19.10963055,  19.40442264, 263.43364791]) {
							translate(v = [0, 0, 2]) {
								cylinder($fn = 50, d = 16.2000000000, h = 50);
							}
							translate(v = [0, 0, -50]) {
								cylinder($fn = 50, d = 5.3000000000, h = 100);
							}
							translate(v = [0, 0, -53]) {
								cylinder($fn = 50, d = 10.0000000000, h = 50);
							}
						}
					}
				}
		...
		difference() {
			rotate(a = [  0,  0,-45]) {
				...
				translate(v = [205.0000000000, 155.0000000000, 30]) {
					rotate(a = [  25.95775351,  22.49187023, 259.45042285]) {
						difference() {
							translate(v = [0, 0, -5]) {
								cylinder($fn = 50, d = 26.2000000000, h = 10);
							}
							cylinder($fn = 50, d = 16.2000000000, h = 5);
						}
					}
