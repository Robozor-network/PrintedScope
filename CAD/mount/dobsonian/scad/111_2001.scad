...
difference() {
	union() {
		difference() {
			cylinder($fn = 50, d = 30, h = 24.0000000000);
			translate(v = [0, 0, 20]) {
				cylinder($fn = 50, d = 10, h = 13.7000000000);
			}
			translate(v = [0, 0, 15]) {
				cylinder($fn = 50, d1 = 0, d2 = 10, h = 5.2000000000);
			}
			rotate(a = [0, 0, 0.0000000000]) {
				translate(v = [5.0000000000, 0, 19.5000000000]) {
					rotate(a = [  0,-90,  0]) {
						union() {
							cube(size = 0);
				...
				translate(v = [15.0000000000, -50, 0]) {
					cube(size = 100);
				}
			}
		...
		cylinder($fn = 50, d = 24, h = 24.0000000000);
	}
	translate(v = [0, 0, 0.2000000000]) {
		cylinder($fn = 50, d = 5.3000000000, h = 24.0000000000);
	}
	rotate(a = 30) {
		translate(v = [0, 0, -0.2000000000]) {
			cylinder($fn = 6, d = 9.2000000000, h = 19.2000000000);
		}
	}
	rotate(a = [0, 0, 0.0000000000]) {
		translate(v = [8, 0, -0.2000000000]) {
			cylinder($fn = 50, d = 6.0000000000, h = 3.2000000000);
			cylinder($fn = 50, d = 4.3000000000, h = 50);
		}
	}
