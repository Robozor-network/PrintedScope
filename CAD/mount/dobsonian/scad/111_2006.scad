...
translate(v = [0, 0, -62.4000000000]) {
	difference() {
		translate(v = [-70, 0, 0]) {
			cube(size = [100, 30, 52.4000000000]);
		}
		translate(v = [0, -0.1000000000, 62.4000000000]) {
			rotate(a = [-90, 0, 0]) {
				cylinder($fn = 50, d = 70, h = 30.2000000000);
			}
		}
		translate(v = [0, 0, 62.4000000000]) {
			rotate(a = [0, -30, 0]) {
				translate(v = [0, 10, -38.0000000000]) {
					rotate(a = [90, 0, 0]) {
						rotate(a = [0,0,0]) {
							union() {
								cube(size = 0);
								...
								translate(v = [0, 0, -14.5000000000]) {
									cylinder(d = 5.3000000000, h = 14.5000000000);
								}
							}
						}
					}
				}
				translate(v = [0, 20, -38.0000000000]) {
					rotate(a = [90, 0, 0]) {
						cylinder($fn = 50, d = 17, h = 30);
					}
				}
			}
		}
		translate(v = [-35., 15., 10.]) {
			rotate(a = [90, 0, 0]) {
				cylinder(d = 2, h = 3);
			}
			translate(v = [0, 0, -10]) {
