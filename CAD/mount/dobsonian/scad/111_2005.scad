...
difference() {
	union() {
		difference() {
			intersection() {
				difference() {
					union() {
						difference() {
							cylinder($fn = 50, d = 504.9747468306, h = 30.0500000000);
							translate(v = [0, 0, -0.0500000000]) {
								cylinder($fn = 50, d = 432.2970377067, h = 30.1500000000);
							}
						}
						translate(v = [0, 0, -0.0500000000]) {
							cylinder($fn = 50, d = 377.2970377067, h = 30.1500000000);
						}
					}
					translate(v = [0, 0, -0.0500000000]) {
						cylinder($fn = 50, d = 337.2970377067, h = 30.1500000000);
					}
				}
				hull() {
									...
									rotate(a = [180, 0, 0]) {
										union() {
											translate(v = [0, 0, false]) {
												cylinder($fn = 50, d = 6.5000000000, h = 41.2000000000);
											}
			...
			mirror(v = [0, 0, 0]) {
				translate(v = [0, 0, 15.0000000000]) {
					rotate(a = [0, 0, 7.5000000000]) {
						translate(v = [153.6485188534, 23.8000000000, 0]) {
							union() {
								rotate(a = [90, 0, 0]) {
									rotate(a = [180, 0, 0]) {
										union() {
		...
		translate(v = [0, 0, 30.0500000000]) {
			intersection() {
				difference() {
					cylinder($fn = 50, d = 504.9747468306, h = 34.0000000000);
					translate(v = [0, 0, -0.0500000000]) {
						cylinder($fn = 50, d = 300, h = 34.1000000000);
					}
				}
				hull() {
					translate(v = [0, 30, 0]) {
						rotate(a = [0, 0, 7.0000000000]) {
							cube(size = [500, 0.1000000000, 34.0500000000]);
						}
					}
					translate(v = [0, -30, 0]) {
						rotate(a = [0, 0, -7.0000000000]) {
		...
		translate(v = [0, 0, 47.0000000000]) {
			rotate(a = [0, 90, 135]) {
				translate(v = [0, 0, 8.5000000000]) {
					cylinder($fn = 50, d = 17.0000000000, h = 100);
				}
			}
		}
	}
