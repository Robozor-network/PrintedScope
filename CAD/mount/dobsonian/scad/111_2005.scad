...
difference() {
	union() {
		difference() {
			intersection() {
				difference() {
					union() {
						difference() {
							cylinder($fn = 20, d = 504.9747468306, h = 30.0500000000);
							translate(v = [0, 0, -0.0500000000]) {
								cylinder($fn = 20, d = 432.2970377067, h = 30.1500000000);
							}
						}
						translate(v = [0, 0, -0.0500000000]) {
							cylinder($fn = 20, d = 377.2970377067, h = 30.1500000000);
						}
					}
					translate(v = [0, 0, -0.0500000000]) {
						cylinder($fn = 20, d = 337.2970377067, h = 30.1500000000);
					}
				}
				hull() {
		...
		translate(v = [0, 0, 30.0500000000]) {
			intersection() {
				difference() {
					cylinder($fn = 20, d = 504.9747468306, h = 33.6000000000);
					translate(v = [0, 0, -0.0500000000]) {
						cylinder($fn = 20, d = 300, h = 33.7000000000);
					}
				}
				hull() {
					translate(v = [0, 30, 0]) {
						rotate(a = [0, 0, 7.0000000000]) {
							cube(size = [500, 0.1000000000, 33.6500000000]);
						}
					}
					translate(v = [0, -30, 0]) {
						rotate(a = [0, 0, -7.0000000000]) {
