...
teeth = puley_teeth;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
profile = 6;		// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm

motor_shaft = 40 + 0.5;	// NEMA17 motor shaft exact diameter = 5
    ...
    difference(){
        ...
        for (i=[1:4]) {
            rotate([0, 0, i*360/4]){
                ...
                translate([30, 0, 10])
                    cylinder(d = M3_nut_diameter, h = 100, $fn = 100);
            }
        }
