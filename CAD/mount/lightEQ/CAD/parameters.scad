...
center_part_length = 130;
center_part_side_wall_thickness = 20;
center_part_width = 70;



nema17_length = 50;
nema17_width = 42.5;
nema17_screw_distance = 31;
nema17_flange_diameter = 23;

puley_teeth = 90;
puley_diameter = 143; // zaktualizovat z výpisu po zmene poctu zubu.

base_axis_length = 60; // delka pouzitych licovanych sroubu
